...
static const char *const admin_email = "system@tanglewoodforest.tk";
static const char *const admin_name = "TWF System";
static const char *const system_name = "TanglewoodForestServer";
