...
bool rename_file( const char* dir1, const char* file1, const char* dir2, const char* file2 )
{
...
void do_dump( char_data* ch, const char *argument )
{
    ...
    if( !*argument ) {
        send( ch, "How do you want to dump the area?\n\r" );
        return;
    }
    ...
    if( *argument ) {
        send( ch, "I don't know that format yet.\n\r" );
        return;
    }
}
